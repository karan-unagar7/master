...
import { getLeaveReportApi } from "../../services/apiCall";
...
function UserLeave() {
  ...
  const columns = [
    { header: "name", accessor: "userDetail.name" },
    { header: "email", accessor: "userDetail.email" },
    { header: "phone", accessor: "userDetail.phone" },
